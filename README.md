...
```
To get a clone of the project, run `git clone https://github.com/white3d/rails-todolist.git`
```
...
Feel free to check the [issues page](https://github.com/white3d/rails-todolist/issues)
